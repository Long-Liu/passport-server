...
//public class DatabaseInitialSetupTest {
////    private DatabaseInitialSetup databaseInitialSetup;
//
...
//
//    public DatabaseInitialSetupTest() {
//        ApplicationPropertiesUtils.addEnvVariables();
//    }
//
////    @Before
////    public void setDatabaseInitialSetup() {
////        this.databaseInitialSetup = new DatabaseInitialSetup();
////    }
//
////    @Test
////    public void addApps() {
////        App app = new App("PassportServer", true);
...
//
//        mongoTemplate.save(new AppAuthority("PassportServer", Authority.USER));
//        mongoTemplate.save(new AppAuthority("PassportServer", Authority.ADMIN));
//        mongoTemplate.save(new AppAuthority("PassportServer", Authority.DEVELOPER));
//        mongoTemplate.save(new AppAuthority("PassportServer", Authority.ANONYMOUS));
//    }
//
//    @Test
//    public void addUserAndAuthories() {
